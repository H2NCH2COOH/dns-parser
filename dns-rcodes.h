...
/* Built from IANA online data at 2026-06-29 17:54:35 +0800 */
...
#define DNS_RCODE_NotAuth 9 /* Not Authorized [RFC8945] */
...
#define DNS_RCODE_BADSIG 16 /* TSIG Signature Failure [RFC8945] */
#define DNS_RCODE_BADKEY 17 /* Key not recognized [RFC8945] */
#define DNS_RCODE_BADTIME 18 /* Signature out of time window [RFC8945] */
...
#define DNS_RCODE_BADTRUNC 22 /* Bad Truncation [RFC8945] */
#define DNS_RCODE_BADCOOKIE 23 /* Bad/missing Server Cookie [RFC7873] */
#define DNS_rcode_RESERVED 65535 /* Can be allocated by Standards Action [RFC6895] */
