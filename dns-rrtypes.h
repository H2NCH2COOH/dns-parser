...
#define DNS_RRTYPE_NXT 30 /* Next Domain (OBSOLETE) [RFC2535][RFC3755] */
...
#define DNS_RRTYPE_NAPTR 35 /* Naming Authority Pointer [RFC3403] */
...
#define DNS_RRTYPE_RRSIG 46 /* RRSIG [RFC4034] */
#define DNS_RRTYPE_NSEC 47 /* NSEC [RFC4034][RFC9077] */
#define DNS_RRTYPE_DNSKEY 48 /* DNSKEY [RFC4034] */
#define DNS_RRTYPE_DHCID 49 /* DHCID [RFC4701] */
#define DNS_RRTYPE_NSEC3 50 /* NSEC3 [RFC5155][RFC9077] */
